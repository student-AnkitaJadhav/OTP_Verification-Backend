...
const transporter = nodemailer.createTransport({
    ...
    auth: {
        user: "genzankitajadhav@gmail.com",
        pass: "ugicwnwxasilxotp",
    },
});
...
exports.register = async (req, res) => {
    try {
        ...
        await transporter.sendMail({
            from: 'genzankitajadhav@gmail.com',
            to: email,
...
exports.verifyOTP = async (req, res) => {
    try {
        ...
        // Remove OTP validation and save
        user.otp = '';  // clear OTP (optional, to avoid security issues)
        user.otpExpiry = undefined;

        // Save the user without triggering the validation
